...
$this->registerJsFile( '@web/js/edit-dealer.js', ['depends' => [\yii\web\JqueryAsset::className()]] );
...
<input type="hidden" name="user_id"  id="user_id" value="<?= $dealer->id; ?>" />
    ...
    <div class="col-md-6">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal form-validate-jquery" method="POST" action="<?= URL::to(['administrator/add-dealer']) ?>" >
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input id="username" type="text" name="username" class="form-control" required="required" value="<?= $dealer->username ?>" placeholder="Введите логин">
                            </div>
                        </div>
                        <!-- /basic text input -->
                ...
                <form class="form-horizontal form-validate-jquery" method="POST" action="" >
                    <fieldset class="content-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="email" name="email" class="form-control" id="email" required="required" value="<?= $dealer->email ?>" placeholder="Введите email">
                            </div>
                        </div>
                        <!-- /email field -->
                ...
                <form class="form-horizontal form-validate-jquery" method="POST" action="" >
                    <fieldset class="content-group">
                        ...
                        <div class="checkbox checkbox-switchery">
                            <label>
                                <input id="status" type="checkbox" class="switchery" <?php if($dealer->status) echo "checked"; ?> data-on-text="Активный" data-off-text="Неактивный"  >
                                Статус
                            </label>
                        </div>
