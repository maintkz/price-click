        ...
        <div class="panel panel-white">
            ...
            <div class="table-responsive">
                <table class="table">
                    <thead>
                    <tr>
                        <th calspan="2"><h6 class="panel-title"><?= $dealer['username']; ?></h6></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>email</td>
                        <td><span class="text-bold"><?= $dealer['email']; ?></span></td>
                    </tr>
                    <tr>
                        <td>Статус</td>
                    ...
                    <tr>
                        <td>Телефон</td>
                        <td><span class="text-bold"><?= $dealer['phone']; ?></td>
                    </tr>
                    <tr>
                        <td>Адрес</td>
                        <td><span class="text-bold"><?= $dealer['address']; ?></td>
                    </tr>
                    <tr>
                        <td>Описание</td>
                        <td><span class="text-bold"><?= $dealer['description']; ?></td>
                    </tr>
                    <tr>
                        <td>Магазины</td>
                    ...
                    <tr>
                        <td>Оборотка по <?= $dealer['username']; ?></td>
                        <td><span class="text-bold"><a href="#">Оборотка по магазинам <?= $dealer['username']; ?></a></span></td>
                    </tr>
                    </tbody>
                </table>
